...
return {
title: json.data.title || json.data.name || 'Desconocido',
artists: json.data.artists || json.data.artist || 'Desconocido',
...
return {
title: json.title || json.name || 'Desconocido',
artists: json.artist || json.artists || 'Desconocido',
lyrics: json.lyrics,
